...
jQuery(function($) {
		...
		$.each(owls, function(key, val) {
				...
				//var timeToNextSlide = opts.time_to_next_slide * 1000;
				//var itemCount = $(this).attr('data-itemcount');
				var itemsToDisplay = opts.items_to_display;

				$(this).owlCarousel({
						items: opts.items_to_display,
						// nav:true,
						loop: true,
						margin: 10,
						center: true,
						autoplay: opts.autoplay,
						autoplayTimeout: opts.time_to_next_slide * 1000,
				});

				$(this).mouseleave(function() {
						$(this).trigger('play.owl.autoplay', opts.time_to_next_slide * 1000);
				});
